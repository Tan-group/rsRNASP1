...
void train_3drna(){
    ...
    // string pdbl = "/home/tc/GIT/rsRNASP_rna2/test/pdb.l";
    string pdbl = "/home/tc/GIT/rsRNASP_rna2/dataset/PDB/RNA_hires_xp/rmdecoy.l";
    // string etable_out = "/home/tc/GIT/rsRNASP_rna2/test/trainxp/energy.dih.dat";
    // string count_out = "/home/tc/GIT/rsRNASP_rna2/test/trainxp/count.dih.dat";

    FILE * count_out =fopen("/home/tc/GIT/rsRNASP_rna2/test/train_3drna/count.dat","w");
    FILE * etable_out = fopen("/home/tc/GIT/rsRNASP_rna2/test/train_3drna/energy.dat","w");
    ...
    for (auto& alpha: valpha){
        for (auto& bin_size: vbin_size){
            for (auto& max_dist: vmax_dist){
                ...
                char path0[200];
                sprintf(path0,"/home/tc/GIT/rsRNASP_rna2/test/train_params/%.2f_%.2f_%.2f", alpha, bin_size,max_dist);
                ...
                // sprintf(path2,"/home/tc/GIT/rsRNASP_rna2/test/train_params/%.2f_%.2f_%.2f/energy.dat", alpha, bin_size,max_dist);
                // system("mkdir -p /home/tc/GIT/rsRNASP_rna2/test/train_params/%.2f_%.2f_%.2f/");
...
//     FILE * count_out =fopen("/home/tc/GIT/rsRNASP_rna2/test/trainxp/count.dih.dat","w");
//     FILE * etable_out = fopen("/home/tc/GIT/rsRNASP_rna2/test/trainxp/energy.dih.dat","w");

//     rsRNASP_dihedral * dc = new rsRNASP_dihedral();

//     dc->train_rsRNASP_dih(pdbl);

//     // dc->print_ersRNASP_dih(stdout);
//     // dc->print_count_dih(stdout);
//     dc->print_ersRNASP_dih(etable_out);
...
//     string count_pn = "/home/tc/GIT/rsRNASP_rna2/test/trainxp/count.dipo.pn.dat";
//     string count_pp = "/home/tc/GIT/rsRNASP_rna2/test/trainxp/count.dipo.pp.dat";
//     string etable_pn = "/home/tc/GIT/rsRNASP_rna2/test/trainxp/energy.dipo.pn.dat";
//     string etable_pp = "/home/tc/GIT/rsRNASP_rna2/test/trainxp/energy.dipo.pp.dat";

//     rsRNASP_dipolar * dc = new rsRNASP_dipolar();



//     dc->train_rsRNASP_dipo(pdbl, 500);

//     // dc->print_count_dipo(stdout, stdout);

//     dc->print_count_dipo(count_pn, count_pp);
//     dc->print_ersRNASP_dipo(etable_pn, etable_pp);
// }
