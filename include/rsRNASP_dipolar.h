#ifndef _rsRNASP_CALC_2
#define _rsRNASP_CALC_2
...
// ================================
// rsRNASP dipolar atom term
//
// ================================

class rsRNASP_dipolar{
...
// so boost::multi_array is used here
    ...
    // double rsRNASP_dipo_pn[matype][matype][dipo_bin][mbin]={};

    // int count_dipo_pp[matype][matype][dipo_bin][mbin]={};
    // double rsRNASP_dipo_pp[matype][matype][dipo_bin][mbin]={};
...
// polar - nonpolar
    ...
    double_array rsRNASP_dipo_pn{boost::extents[polartypen][matype][dipo_bin][mbin]};
// polar -polar
    int_array count_dipo_pp{boost::extents[polartypen][polartypen][dipo_bin][mbin]};
    double_array rsRNASP_dipo_pp{boost::extents[polartypen][polartypen][dipo_bin][mbin]};
    ...
    void init_rsRNASP_etable_dipo(std::string);


// dipo
    void train_rsRNASP_dipo(string pdbl_fpath, int length_limit = 1000);

    // deprecated
    // double calc_rsRNASP_dipo(chain & achain);

    std::pair<double, double> calc_rsRNASP_dipo(rna & astr);
    void init_rsRNASP_dipo();
    void init_rsRNASP_dipo(std::string);

    void print_count_dipo(string &,string &);
    void print_ersRNASP_dipo(string &, string &);

    void print_count_dipo(FILE * out_pn, FILE * out_pp);
    void print_ersRNASP_dipo(FILE * out_pn, FILE * out_pp);
...
// ==============================================
// rsRNASP dipolar
// use get_rsRNASP(structure & astr) to get energy
// ==============================================

    rsRNASP_dipolar(std::string energy_dir){
        // param_p = new smcra_param();
        init_rsRNASP_etable_dipo(energy_dir);
    }
    ...
    // double get_rsRNASP(structure & astr){return calc_rsRNASP_dipo(astr);};
    // std::pair<double, double> get_rsRNASP(structure & astr){return calc_rsRNASP_dipo(astr);};
   std::pair<double, double> get_rsRNASP(rna & astr){return calc_rsRNASP_dipo(astr);};
    void get_rsRNASP_per_res(structure & astr, FILE *out);

    void get_rsRNASP_profile(structure & astr, FILE *out);
};
